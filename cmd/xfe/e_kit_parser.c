...
{"button 1", "*urlBar*whatsNew.labelString", NULL, default_handler, {NULL}},
{"button 2", "*urlBar*whatsCool.labelString", NULL, default_handler, {NULL}},
{"button 3", "*urlBar*manual.labelString", NULL, default_handler, {NULL}},
{"button 4", "*urlBar*inetSearch.labelString", NULL, default_handler, {NULL}},
{"button 5", "*urlBar*inetIndex.labelString", NULL, default_handler, {NULL}},
{"button 6", "*urlBar*software.labelString", NULL, default_handler, {NULL}},
{"button 1 url", ".whatsNewBUrl", NULL, default_handler, {NULL}},
{"button 2 url", ".whatsCoolBUrl", NULL, default_handler, {NULL}},
{"button 3 url", ".manualBUrl", NULL, default_handler, {NULL}},
{"button 4 url", ".inetSearchBUrl", NULL, default_handler, {NULL}},
{"button 5 url", ".inetIndexBUrl", NULL, default_handler, {NULL}},
{"button 6 url", ".softwareBUrl", NULL, default_handler, {NULL}},
{"directory 1", "*menuBar*netscape", NULL, menu_handler, {NULL}},
{"directory 2", "*menuBar*whatsNew", NULL, menu_handler, {NULL}},
{"directory 3", "*menuBar*whatsCool", NULL, menu_handler, {NULL}},
{"directory 4", "*menuBar*directoryMenu4", NULL, menu_handler, {NULL}},
{"directory 5", "*menuBar*galleria", NULL, menu_handler, {NULL}},
{"directory 6", "*menuBar*inetIndex", NULL, menu_handler, {NULL}},
{"directory 7", "*menuBar*inetSearch", NULL, menu_handler, {NULL}},
{"directory 8", "*menuBar*inetWhite", NULL, menu_handler, {NULL}},
{"directory 9", "*menuBar*inetAbout", NULL, menu_handler, {NULL}},
...
{"help 1", "*menuBar*aboutplugins", NULL, menu_handler, {NULL}},
{"help 2", "*menuBar*registration", NULL, menu_handler, {NULL}},
{"help 3", "*menuBar*upgrade", NULL, menu_handler, {NULL}},
{"help 4", "*menuBar*helpMenu4", NULL, menu_handler, {NULL}},
{"help 5", "*menuBar*manual", NULL, menu_handler, {NULL}},
{"help 6", "*menuBar*relnotes", NULL, menu_handler, {NULL}},
{"help 7", "*menuBar*faq", NULL, menu_handler, {NULL}},
{"help 8", "*menuBar*aboutSecurity", NULL, menu_handler, {NULL}},
{"help 9", "*menuBar*directoryMenu9", NULL, menu_handler, {NULL}},
{"help 10", "*menuBar*feedback", NULL, menu_handler, {NULL}},
{"help 11", "*menuBar*support", NULL, menu_handler, {NULL}},
{"help 12", "*menuBar*howTo", NULL, menu_handler, {NULL}},
...
{"help 1 url", ".aboutpluginsUrl", NULL, default_handler, {NULL}},
{"help 2 url", ".registrationUrl", NULL, default_handler, {NULL}},
{"help 3 url", ".upgradeUrl", NULL, default_handler, {NULL}},
{"help 4 url", ".helpMenu4Url", NULL, default_handler, {NULL}},
{"help 5 url", ".manualUrl", NULL, default_handler, {NULL}},
{"help 6 url", ".relnotesUrl", NULL, default_handler, {NULL}},
{"help 7 url", ".faqUrl", NULL, default_handler, {NULL}},
{"help 8 url", ".aboutSecurityUrl", NULL, default_handler, {NULL}},
{"help 9 url", ".directoryMenu9Url", NULL, default_handler, {NULL}},
{"help 10 url", ".feedbackUrl", NULL, default_handler, {NULL}},
{"help 11 url", ".supportUrl", NULL, default_handler, {NULL}},
{"help 12 url", ".howToUrl", NULL, default_handler, {NULL}},
