 ...
 *
 * $Id: secpkcs7.h,v 1.12.2.5 1997/04/26 00:01:25 jwz Exp $
 */
...
/*
 * There will be a similar routine for creating signedAndEnvelopedData.
...
/*
 * All of the following things that return SECStatus to signal success
 * or failure.  Failure should have a more specific error status available
 * via PORT_GetError()/XP_GetError().
 */
