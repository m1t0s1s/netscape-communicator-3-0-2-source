...
int main(int argc, char **argv)
{
	...
	/* encode to add tag and ber encoding */
	...
	if (test_long == output_long)
		printf ("neg_int-Encoding and decoding Integer: Test passed \n");
	else {
...
loser: printf("neg_int-Encoding and decoding Integer:Test failed\n");
	   goto end_prog;
