...
int main(int argc, char **argv)
{
	...
	if (test_long == output_long)
		printf ("sim_neg_objid-Encoding and decoding Object Identifier: Test passed \n");
	else {
...
loser: printf("sim_neg_objid-Encoding and decoding Object Identifier:Test failed\n");
	   goto end_prog;
