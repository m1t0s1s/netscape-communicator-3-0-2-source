...
int main(int argc, char **argv)
{
	...
	if (rc == 0)
		printf ("sim_neg_ia5string-Encoding and decoding IA5String: Test passed \n");
	else {
...
loser: printf("sim_neg_ia5string-Encoding and decoding IA5string:Test failed\n");
	   goto end_prog;
