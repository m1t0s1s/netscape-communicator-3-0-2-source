...
#include "secder.h"
/*
/* SMIME -Test 001- Printable string  Simple test to check encoding and decoding API. 
...
int main(int argc, char **argv)
{
    ...
    printf ("\n Begin sim_pos_printable string test \n");
	...
	if (rc == 0)
		printf ("sim_pos_printable string-Encoding and decoding: Test passed \n");
	else {
...
loser: printf("sim_pos_printable string-Encoding and decoding :Test failed\n");
	   goto end_prog;
