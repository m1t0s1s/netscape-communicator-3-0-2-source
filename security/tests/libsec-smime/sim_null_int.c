...
#include "secder.h"
/*
/* SMIME -Test 001- NULL  Simple test to check encoding and decoding API. */
...
int main(int argc, char **argv)
{
	...
	rv = SEC_ASN1DecodeItem (arena, &decoded_data, SEC_NullTemplate,
							   &encoded_output); 
	...
	if (test_long == output_long)
		printf ("null_int-Encoding and decoding Integer: Test passed \n");
	else {
...
loser: printf("null_int-Encoding and decoding Integer:Test failed\n");
	   goto end_prog;
