...
int main(int argc, char **argv)
{
	...
	/* then encode item to add tag and ber encoding */
	...
	if (test_long == output_long)
		printf ("pos_int-Encoding and decoding Integer: Test passed \n");
	else {
...
loser: printf("pos_int-Encoding and decoding Integer:Test failed\n");
	   goto end_prog;
