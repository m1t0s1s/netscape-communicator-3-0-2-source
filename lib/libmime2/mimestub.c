...
{
#ifndef MIME_SECURITY
  XP_ASSERT(0);
#endif /* !MIME_SECURITY */
  strcpy(path, "/tmp/biteme"); 
}


#ifndef MIME_SECURITY
PRMonitor* _pr_TempName_lock = 0;
void PR_EnterMonitor(void *x) {}
void PR_ExitMonitor(void *x) {}
void _PR_Assert(const char *ex, const char *file, int line) 
{
# ifndef NDEBUG
  abort();
# endif
