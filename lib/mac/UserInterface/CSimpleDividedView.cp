...
//	CSimpleDividedView.cp					  ©1996 Netscape. All rights reserved.
//
...
// ---------------------------------------------------------------------------
//		¥ CreateSimpleDividedView 
// ---------------------------------------------------------------------------
// same old plain stream constructor
 
CSimpleDividedView *CSimpleDividedView::CreateSimpleDividedView(LStream *inStream)
{
	return new CSimpleDividedView(inStream);
}
...
void CSimpleDividedView::ClickSelf(const SMouseDownEvent	&inMouseDown)
{
	...
	// Drag it
	dragDistance = ::DragGrayRgn(	rgn.mRgn, inMouseDown.whereLocal, 
								&limitRect, &slopRect, 
