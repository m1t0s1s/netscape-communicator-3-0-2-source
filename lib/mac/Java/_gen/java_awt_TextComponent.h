...
#include "native.h"
/* Header for class java_awt_TextComponent */

#ifndef _Included_java_awt_TextComponent
#define _Included_java_awt_TextComponent
...
typedef struct Classjava_awt_TextComponent {
    ...
    long selStart;
    long selEnd;
} Classjava_awt_TextComponent;
HandleTo(java_awt_TextComponent);
