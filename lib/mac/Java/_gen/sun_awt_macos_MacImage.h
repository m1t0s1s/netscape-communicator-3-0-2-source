...
#include "native.h"
/* Header for class sun_awt_macos_MacImage */

#ifndef _Included_sun_awt_macos_MacImage
#define _Included_sun_awt_macos_MacImage
...
typedef struct Classsun_awt_macos_MacImage {
...
} Classsun_awt_macos_MacImage;
HandleTo(sun_awt_macos_MacImage);
