...
#include "native.h"
/* Header for class java_awt_Button */

#ifndef _Included_java_awt_Button
#define _Included_java_awt_Button
...
typedef struct Classjava_awt_Button {
...
} Classjava_awt_Button;
HandleTo(java_awt_Button);
