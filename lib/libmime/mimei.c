...
#ifdef DEBUG_jwz
  /* I've decided I want Content-Disposition to always default to "inline".
     If it can be displayed inline, it should be, and I'll choose "Show
     Attachments As Links" if that's what I want.  (That pref was handled
     in mime_find_class() -- `class' is already mimeExternalObjectClass if
     that was turned on.)
   */
  content_disposition = 0;
#endif /* DEBUG_jwz */
