 ...
 * Ben Bucksch <http://www.bucksch.org/1/projects/mozilla/</a>>.
...
/* backported to ns3 by jwz, 2-Nov-2004 */
...
# define PRUint32 uint32
# define NS_ASSERTION(TEST,WHY) XP_ASSERT(TEST)
