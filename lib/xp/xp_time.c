/* -*- Mode: C; tab-width: 4 -*-
   ...
   Copyright © 1995, 1996 Netscape Communications Corporation, all rights reserved.
      ...
      if (s[0] == 'D' || s[0] == 'd')
		{
		  ...
		  if (s && *s)
			{
			  time_t t = XP_ParseTimeString (++s,
											 /* (flip = !flip) */
											 TRUE
											 );
			  count++;
			  if (/* t < 757411200L || "jan  1 00:00:00 1994" */
				  t < 631180800L || /* "jan  1 00:00:00 1990" */
				  t > 883641600L)   /* "jan  1 00:00:00 1998" */
				{
				  if (t < 1)
					failed++;
				  else
