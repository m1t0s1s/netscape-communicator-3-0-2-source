...
PRIVATE int net_ExtConverterWrite (void *closure,
								   CONST char* output_buffer,
								   int32 output_length)
{
  CVG_DataObject *data = (CVG_DataObject *) closure;
...
PRIVATE int net_ExtConverterWriteReady (void *closure)
{
...
PRIVATE void net_ExtConverterComplete (void *closure)
{
  CVG_DataObject *data = (CVG_DataObject *) closure;
...
PRIVATE void net_ExtConverterAbort (void *closure, int status)
{
  CVG_DataObject *data = (CVG_DataObject *) closure;
