...
PRIVATE int net_ExtViewWrite (CV_DataObject * obj, CONST char* s, int32 l)
{
	if(obj->tot_size)
	  {
		obj->cur_size += l;
...
PRIVATE int net_ExtViewWriteReady (CV_DataObject * obj)
{
    fd_set write_fds;
...
PRIVATE void net_ExtViewComplete (CV_DataObject * obj)
{
...
PRIVATE void net_ExtViewAbort (CV_DataObject * obj, int status)
{
	obj->context->funcs->SetProgressBarPercent(obj->context, 100);
