 ...
 *
 * $Id: secasn1t.h,v 1.3.2.1 1997/04/26 00:02:05 jwz Exp $
 */
...
#define SEC_ASN1_MAY_STREAM	0x40000	/* field or one of its sub-fields may
					 ...
					 * encoding */
#define SEC_ASN1_SKIP_REST	0x80000	/* skip all following fields; only for decoding */
 ...
 * when doing anything "funny" (e.g. to manipulating the data stream)
 */ 
