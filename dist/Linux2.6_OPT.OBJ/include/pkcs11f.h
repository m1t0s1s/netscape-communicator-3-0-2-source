...
#ifdef CK_NEED_ARG_LIST
(
    CK_FUNCTION_LIST_PTR_PTR ppFunctionList /* receives pointer to list of functions */
);
#endif
...
/* C_GetOperationState saves the state of the cryptographic operation in a session. */
CK_EXTERN _CK_RV CK_FUNC(C_GetOperationState)
#ifdef CK_NEED_ARG_LIST
(
    CK_SESSION_HANDLE	hSession,	/* the session's handle */
    CK_BYTE_PTR		pOperationState, /* the location receiving the state */
    CK_ULONG_PTR	pulOperationStateLen /* the location receiving the state length. */
);
#endif
...
(
    ...
    CK_ULONG		ulOperationStateLen, /* the location holding the state length */
    CK_OBJECT_HANDLE	hEncryptionKey,	/* handle of the key for encryption/decryption */
    CK_OBJECT_HANDLE	hAuthenticationKey /* handle of the key for signing/verifying. */
);
#endif
...
(
    CK_SESSION_HANDLE	hSession,	/* the session's handle */
    CK_BYTE_PTR		pEncryptedData,	/* input encrypted data */
    CK_ULONG		ulEncryptedDataLen, /* count of byes of input */
    CK_BYTE_PTR		pData,		/* receives decrypted output */
    CK_ULONG_PTR	pulDataLen	/* receives decrypted byte count. */
);
#endif
...
(
    ...
    CK_ULONG		ulPublicKeyAttributeCount, /* no of public attributes*/
    CK_ATTRIBUTE_PTR	pPrivateKeyTemplate,	/* private attribute template */
    CK_ULONG		ulPrivateKeyAttributeCount,/* no of private attributes*/
