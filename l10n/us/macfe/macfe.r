...
/*8x*/	$"A5AA E2C4 E3C9 A0E0 F6E4 C9DC CED9 DAB6"    /* •™≠∞≥∑∫Ω√≈…—‘Ÿ⁄∂ */
/*9x*/	$"C6D4 D5D2 D3A5 D0D1 F7AA FBDD CFFF F5D9"    /* ∆Œ‚„‰ˆ˜˘˙˚˝˛ˇıƒ */
/*Ax*/	$"CAC1 A2A3 DBB4 7CA4 ACA9 BBC7 C2D0 A8F8"    /*  ¡¢£€¥œ§¨©ª«¬–®¯ */
/*Bx*/	$"A1B1 3233 ABB5 A6E1 FC31 BCC8 B9B8 B2C0"    /* °±”“´µ¶·¸’º»π∏≤¿ */
/*Cx*/	$"CBE7 E5CC 8081 AE82 E983 E6E8 EDEA EBEC"    /* ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏ */
/*Dx*/	$"DC84 F1EE EFCD 8578 AFF4 F2F3 86A0 DEA7"    /* ‹ÑÒÓÔÕÖ◊ØÙÚÛÜ†ﬁß */
/*Ex*/	$"8887 898B 8A8C BE8D 8F8E 9091 9392 9495"    /* àáâãäåæçèéêëìíîï */
/*Fx*/	$"DD96 9897 999B 9AD6 BF9D 9C9E 9FE0 DFD8"    /* ›ñòóôõö÷øùúûü‡ﬂÿ */
};
...
/*6x*/	$"6061 6263 6465 6667 6869 6A6B 6C6D 6E6F"    /* `abcdefghijklmno */
/*7x*/	$"7071 7273 7475 7677 7879 7A7B 7C7D 7E7F"    /* pqrstuvwxyz{|}~. */
/*8x*/	$"C4C5 C7C9 D1D6 DCE1 E0E2 E4E3 E5E7 E9E8"    /* ÄÅÇÉÑÖÜáàâäãåçéè */
/*9x*/	$"EAEB EDEC EEEF F1F3 F2F4 F6F5 FAF9 FBFC"    /* êëíìîïñóòôöõúùûü */
/*Ax*/	$"DDB0 A2A3 A780 B6DF AEA9 99B4 A882 C6D8"    /* †°¢£§•¶ß®©™´¨≠ÆØ */
/*Bx*/	$"83B1 BE84 A5B5 8F85 BDBC 86AA BA87 E6F8"    /* ∞±≤≥¥µ∂∑∏π∫ªºΩæø */
/*Cx*/	$"BFA1 AC88 9F89 90AB BB8A A0C0 C3D5 91A6"    /* ¿¡¬√ƒ≈∆«»… ÀÃÕŒœ */
/*Dx*/	$"AD8B B3B2 8CB9 F7D7 FF8D 8EA4 D0F0 DEFE"    /* –—“”‘’÷◊ÿŸ⁄€‹›ﬁﬂ */
/*Ex*/	$"FDB7 9293 94C2 CAC1 CBC8 CDCE CFCC D3D4"    /* ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ */
/*Fx*/	$"95D2 DADB D99E 9697 AF98 999A B89B 9C9D"    /* ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ */
};
