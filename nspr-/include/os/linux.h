...
/* jwz */
#define PR_GetSP(_t) (_t)->context[0].__jmpbuf[0].__sp
...
{						  \
    ...
    (_thread)->asyncArg0 = o;			  \
    (_thread)->asyncArg1 = a;			  \
    (_thread)->context[0].__jmpbuf[0].__bp = 0;		  \
    (_thread)->context[0].__jmpbuf[0].__sp = (unsigned char*) \
	((_thread)->stack->stackTop - 64);	  \
    (_thread)->context[0].__jmpbuf[0].__pc = HopToadNoArgs;	  \
}
