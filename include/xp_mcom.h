...
#ifdef XP_WIN 
#define XP_FILENAMECMP	 	_stricmp	
#else
#define XP_FILENAMECMP		XP_STRCMP
#endif


#if 0 /* jwz: RH 6.1 loses on this */
#ifndef XP_WIN
...
/* this sucks, should I really include this here or what?
 */
#ifdef XP_MAC
#include "prprf.h"  
#else
...
#ifdef XP_WIN 
#define XP_IS_ALPHA(VAL)                (__isascii((int)(VAL)) && isalpha((int)(VAL)))
#else
