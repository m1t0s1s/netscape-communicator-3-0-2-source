...
#define java_lang_String_length(env, obj) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_length))

/*** public charAt (I)C ***/
#define java_lang_String_charAt(env, obj, a) \
	(JRI_CallMethodChar(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_charAt, a))
...
#define java_lang_String_equals(env, obj, a) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_equals, a))

/*** public equalsIgnoreCase (Ljava/lang/String;)Z ***/
#define java_lang_String_equalsIgnoreCase(env, obj, a) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_equalsIgnoreCase, a))

/*** public compareTo (Ljava/lang/String;)I ***/
#define java_lang_String_compareTo(env, obj, a) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_compareTo, a))

/*** public regionMatches (ILjava/lang/String;II)Z ***/
#define java_lang_String_regionMatches(env, obj, a, b, c, d) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_regionMatches, a, b, c, d))

/*** public regionMatches (ZILjava/lang/String;II)Z ***/
#define java_lang_String_regionMatches_1(env, obj, a, b, c, d, e) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_regionMatches_1, a, b, c, d, e))

/*** public startsWith (Ljava/lang/String;I)Z ***/
#define java_lang_String_startsWith(env, obj, a, b) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_startsWith, a, b))

/*** public startsWith (Ljava/lang/String;)Z ***/
#define java_lang_String_startsWith_1(env, obj, a) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_startsWith_1, a))

/*** public endsWith (Ljava/lang/String;)Z ***/
#define java_lang_String_endsWith(env, obj, a) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_endsWith, a))

/*** public hashCode ()I ***/
#define java_lang_String_hashCode(env, obj) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_hashCode))

/*** public indexOf (I)I ***/
#define java_lang_String_indexOf(env, obj, a) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_indexOf, a))

/*** public indexOf (II)I ***/
#define java_lang_String_indexOf_1(env, obj, a, b) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_indexOf_1, a, b))

/*** public lastIndexOf (I)I ***/
#define java_lang_String_lastIndexOf(env, obj, a) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_lastIndexOf, a))

/*** public lastIndexOf (II)I ***/
#define java_lang_String_lastIndexOf_1(env, obj, a, b) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_lastIndexOf_1, a, b))

/*** public indexOf (Ljava/lang/String;)I ***/
#define java_lang_String_indexOf_2(env, obj, a) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_indexOf_2, a))

/*** public indexOf (Ljava/lang/String;I)I ***/
#define java_lang_String_indexOf_3(env, obj, a, b) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_indexOf_3, a, b))

/*** public lastIndexOf (Ljava/lang/String;)I ***/
#define java_lang_String_lastIndexOf_2(env, obj, a) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_lastIndexOf_2, a))

/*** public lastIndexOf (Ljava/lang/String;I)I ***/
#define java_lang_String_lastIndexOf_3(env, obj, a, b) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_lastIndexOf_3, a, b))
...
#define java_lang_String_utfLength(env, obj) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_String_utfLength))
...
struct java_lang_String : virtual public java_lang_Object {
