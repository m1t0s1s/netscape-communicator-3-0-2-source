...
#define java_io_InputStream_read(env, obj) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_io_InputStream_read))

/*** public read ([B)I ***/
#define java_io_InputStream_read_1(env, obj, a) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_io_InputStream_read_1, a))

/*** public read ([BII)I ***/
#define java_io_InputStream_read_2(env, obj, a, b, c) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_io_InputStream_read_2, a, b, c))

/*** public skip (J)J ***/
#define java_io_InputStream_skip(env, obj, a) \
	(JRI_CallMethodLong(env)(env, JRI_CallMethod_op, obj, methodID_java_io_InputStream_skip, a))

/*** public available ()I ***/
#define java_io_InputStream_available(env, obj) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_io_InputStream_available))
...
#define java_io_InputStream_markSupported(env, obj) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_io_InputStream_markSupported))
...
struct java_io_InputStream : virtual public java_lang_Object {
