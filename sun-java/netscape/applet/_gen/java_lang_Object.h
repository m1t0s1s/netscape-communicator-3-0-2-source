...
#define java_lang_Object_hashCode(env, obj) \
	(JRI_CallMethodInt(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_Object_hashCode))

/*** public equals (Ljava/lang/Object;)Z ***/
#define java_lang_Object_equals(env, obj, a) \
	(JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, obj, methodID_java_lang_Object_equals, a))
