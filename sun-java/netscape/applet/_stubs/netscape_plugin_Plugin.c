...
netscape_plugin_Plugin_getPeer(JRIEnv* env, struct netscape_plugin_Plugin* self) {
	...
	return JRI_CallMethodInt(env)(env, JRI_CallMethod_op, self, methodID_netscape_plugin_Plugin_getPeer);
}
#endif /* DEBUG */
...
netscape_plugin_Plugin_isActive(JRIEnv* env, struct netscape_plugin_Plugin* self) {
	...
	return JRI_CallMethodBoolean(env)(env, JRI_CallMethod_op, self, methodID_netscape_plugin_Plugin_isActive);
}
#endif /* DEBUG */
...
use_netscape_plugin_Plugin(JRIEnv* env)
{
	if (_globalclass_netscape_plugin_Plugin == NULL) {
		...
		return (struct java_lang_Class*)JRI_GetGlobalRef(env, _globalclass_netscape_plugin_Plugin);
	}
}
...
{
	if (_globalclass_netscape_plugin_Plugin != NULL) {
		struct java_lang_Class* clazz = (struct java_lang_Class*)JRI_GetGlobalRef(env, _globalclass_netscape_plugin_Plugin);
