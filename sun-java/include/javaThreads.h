...
#define JAVASTACKSIZE ((uint32_t)400L * (uint32_t)1024L)     /* Default size of a thread java stack */

extern long ProcStackSize;		/* Actual size of thread C stack */
extern uint32_t JavaStackSize;		/* Actual maximum size of java stack */
