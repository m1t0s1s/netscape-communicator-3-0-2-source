/*
 * @(#)TinyFontMetrics.java	1.2 95/10/28 Arthur van Hoff
 *
 ...
 * 
 * @version 1.2 28 Oct 1995
 * @author Arthur van Hoff
 */
class TinyFontMetrics extends FontMetrics {
    /**
     ...
     */
    public TinyFontMetrics(Font font) {
	super(font);
	init();
    }
	...
	if (fm == null) {
	    table.put(font, fm = new TinyFontMetrics(font));
	}
	return fm;
    }
}
