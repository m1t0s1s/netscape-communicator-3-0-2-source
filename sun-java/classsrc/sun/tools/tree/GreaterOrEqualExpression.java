/*
 * @(#)GreaterOrEqualExpression.java	1.11 95/09/14 Arthur van Hoff
 *
...
class GreaterOrEqualExpression extends BinaryCompareExpression {
	...
	switch (left.type.getTypeCode()) {
	  case TC_INT:
		...
		asm.add(where, whenTrue ? opc_if_icmpge : opc_if_icmplt, lbl);
		return;
	    }
	    break;
	  case TC_LONG:
	...
	asm.add(where, whenTrue ? opc_ifge : opc_iflt, lbl);
    }
}
