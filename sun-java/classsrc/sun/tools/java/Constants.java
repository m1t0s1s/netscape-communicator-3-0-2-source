/*
 * @(#)Constants.java	1.50 95/11/17 Arthur van Hoff
 *
...
interface Constants extends RuntimeConstants {
    ...
    public static final Identifier idJavaLangCloneable = 
	  Identifier.lookup("java.lang.Cloneable");

    public static final Identifier idJavaLangError = 
	  Identifier.lookup("java.lang.Error");
    public static final Identifier idJavaLangException = 
	  Identifier.lookup("java.lang.Exception");
    public static final Identifier idJavaLangObject = 
	  Identifier.lookup("java.lang.Object");
    public static final Identifier idJavaLangRuntimeException = 
	  Identifier.lookup("java.lang.RuntimeException");
    public static final Identifier idJavaLangString = 
	  Identifier.lookup("java.lang.String");
    public static final Identifier idJavaLangStringBuffer = 
	  Identifier.lookup("java.lang.StringBuffer");
    public static final Identifier idJavaLangThrowable = 
	  Identifier.lookup("java.lang.Throwable");



    public static final Identifier idConstantValue = 
	  Identifier.lookup("ConstantValue");
    public static final Identifier idLocalVariables = 
	  Identifier.lookup("LocalVariables");
    public static final Identifier idLineNumberTable = 
	  Identifier.lookup("LineNumberTable");
    public static final Identifier idSourceFile = 
	  Identifier.lookup("SourceFile");
    public static final Identifier idDocumentation = 
	   Identifier.lookup("Documentation");
    public static final Identifier idExceptions = 
	   Identifier.lookup("Exceptions");
    ...
    public final int MM_FIELD		= M_PUBLIC | M_PRIVATE | M_PROTECTED |
					  M_FINAL | M_STATIC | M_TRANSIENT | M_VOLATILE;
    public final int MM_METHOD		= M_PUBLIC | M_PRIVATE | M_PROTECTED |
