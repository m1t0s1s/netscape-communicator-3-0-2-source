/*
 * @(#)UUEncoder.java	1.8 95/10/08 Chuck McManis
 *
...
public class UUEncoder extends CharacterEncoder {
     ...
     */
    void encodeBufferPrefix(OutputStream a) throws IOException { 
     ...
     */
    void encodeBufferSuffix(OutputStream a) throws IOException { 
