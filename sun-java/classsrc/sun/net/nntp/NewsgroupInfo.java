/*
 * @(#)NewsgroupInfo.java	1.12 95/08/29 Jonathan Payne, James Gosling
 *
...
public class NewsgroupInfo {
    ...
    public void reload(NntpClient nntp) throws IOException {
	NewsgroupInfo newinfo = nntp.getGroup(name);
	this.firstArticle = newinfo.firstArticle;
	this.lastArticle = newinfo.lastArticle;
    }
}
