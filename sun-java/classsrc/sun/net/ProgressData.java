/*
 * @(#)ProgressData.java	1.7 95/08/22 Chris Warth
 *
...
//		}
//
/* REMIND: content type is not available! */
		te = new ProgressEntry(m, m.getFile(), null/*m.getContentType()*/) ;
		streams[i] = te;
		lastchanged = i;
		what = NEW;
		setChanged();
...
/* REMIND: should get the URLConnection, instead of the URL, in order to
