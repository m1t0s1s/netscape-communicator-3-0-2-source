/*
 * @(#)DatagramSocket.java	1.6 95/12/02 Pavani Diwanji
 *
...
class DatagramSocket {
    ...
    public DatagramSocket() throws SocketException {
                // hack: why don't we require a security check here??
    ...
    synchronized public void receive(DatagramPacket p) throws IOException {
    ...
    private native void multicastJoinLeave(InetAddress inetaddr, boolean join);
}
