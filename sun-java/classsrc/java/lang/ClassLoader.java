...
public abstract class ClassLoader {
	...
	SecurityManager.checksCreateClassLoader(1);
	init();
	initialized = true;
    }
     ...
     * This method is deprecated in favor of the version that takes a "name"
     * as a first argument, and is *MUCH* more secure.
     */
    ...
    /**
     * Converts an array of bytes to an instance of a named class Class. Before the
     * Class can be used it must be resolved.
    ...
    /* Throw an exception if this class is not properly initialized.
     * This method is used predominantly in the C code (directly)
     */
    private native void checkInitialized();
}
