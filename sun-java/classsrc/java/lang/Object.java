...
public class Object {
     ...
     * <em>The method notify() can only be called by the thread that is
     * the owner of the current object's monitor.</em>
     *
     ...
     * change before proceeding can call wait(). <p>
     * <em>The method notifyAll() can only be called by the thread that is
     * the owner of the current object's monitor.</em>
     *
     * @exception	IllegalMonitorStateException If the current thread
     * 			    is not the owner of the Object's monitor.
    ...
    /**
     * More accurate wait.
     * <em>The method wait() can only be called by the thread that is
     * the owner of the current object's monitor.</em>
     *
     * @param timeout	the maximum time to wait in milliseconds
