...
class Thread implements Runnable {
    ...
    /* Indicator of whether this thread has been interrupted */
	...
	// Note that this method is not syncronized.  Three reasons for this:
	...
	//    exactly when it's done wrt probes via the interrupted() function.
	...
	// REMIND: this is only an 90% solution
	// In particular, none of the methods which should throw
	// InterruptedException() currently support that yet.
	...
	// XXX For now, we'll just make setPriority a no-op if security is violated.
	// I think the right answer though is that you should be able to change
	// your priority as long as it doesn't exceed the maximum established by
	// your thread group.
	try {
	    SecurityManager.checksAccess(this, 1);
	} catch (SecurityException e) {
	    return;	// no, you can't set the priority
	}
    ...
    public void checkAccess() {
        /* Wrong stack depth for backward compatability. Remember we shouldn't
         * be called anyway. */
