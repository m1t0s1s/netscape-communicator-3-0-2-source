/*
 * @(#)Checkbox.java	1.12 95/11/09 Sami Shaio
 *
...
public class Checkbox extends Component {
     ...
     * @param label the leabel on the Checkbox
     */
     ...
     * one Checkbox in a CheckboxGroup may be set at a a time.
