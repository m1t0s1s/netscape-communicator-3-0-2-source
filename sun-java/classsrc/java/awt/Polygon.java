/*
 * @(#)Polygon.java	1.7 95/10/25 Sami Shaio
 *
...
public class Polygon {
    ...
    /**
     * Appends a point to a polygon.  If inside(x, y) or other operation
    ...
    /**
     * getBoundingBox() - what area does this polygon span?
    ...
    /**
     * Is point (x, y) inside the polygon?  Uses an even-odd insideness
     * rule (otherwise known as an alternating rule).
     * @param x the X coordinate of the point to be tested
     * @param y the Y coordinate of the point to be tested
     *
     * Based on code by Hanpeter van Vliet <hvvliet@inter.nl.net>.
     */
