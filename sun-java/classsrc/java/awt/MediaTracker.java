/*
 * @(#)MediaTracker.java	1.13 95/12/07 Jim Graham
 *
...
public class MediaTracker {
    ...
    /**
     * Return a list of all media that have encountered an error.
     ...
     * are aborted, or receive an error.
     * If there is an error while loading or scaling an image then that
     * image is considered "complete".
    ...
    /**
     * Start loading all images and wait until they have finished loading,
     * are aborted, receive an error, or until the specified timeout has
     * elapsed.
     * If there is an error while loading or scaling an image then that
     * image is considered "complete".
     * Use isErrorAny or statusAll to check for errors.
    ...
    /**
     * Return the boolean OR of the status of all of the media being
     * tracked.
    ...
    /**
     * Return a list of media with the specified ID that have encountered
     * an error.
    ...
    /**
     * Start loading all images with the specified ID and wait until they
     * have finished loading or receive an error, or until the specified
     * timeout has elapsed.
     * If there is an error while loading or scaling an image then that
     * image is considered "complete".
     * Use statusID or isErrorID to check for errors.
    ...
    /**
     * Return the boolean OR of the status of all of the media with
     * a given ID.
     * @param id the identifier used to determine which images to check
     * @param load specifies whether to start the media loading
     * @see #statusAll
