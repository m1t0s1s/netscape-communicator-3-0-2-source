/*
 * @(#)ImageConsumer.java	1.9 95/12/04 Jim Graham
 *
 ...
 * producer, the producer will deliver all of the data about the image
 * using the method calls defined in this interface.
 *
 * @see ImageProducer
 *
 * @version	1.9 04 Dec 1995
 * @author 	Jim Graham
 */
public interface ImageConsumer {
    ...
    /**
     * The ColorModel object which will be used for the majority of
     * the pixels that will be reported using the setPixels method
     ...
     * may be seen is when looking at a filtered image when the filter
     * determines for each set of pixels that it filters whether the
     ...
     * indicated hint, then the results are undefined.
     */
     ...
     * example of an image format which does not meet this criteria
     ...
     * would not meet this criteria would be the output of a video feed,
     * or the representation of a 3D rendering which is being manipulated
     ...
     * unless it is interested in succeeding frames.
