/*
 * @(#)CropImageFilter.java	1.2 95/08/29 Jim Graham
 *
...
public class CropImageFilter extends ImageFilter {
    ...
    /**
     * Construct a CropImageFilter that extracts the absolute rectangular
    ...
    /**
     * Determine if the delivered byte pixels intersect the region to
